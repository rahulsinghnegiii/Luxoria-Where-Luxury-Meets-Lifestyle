        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="text-lg font-bold text-gray-800">
              Shop<span className="text-[#ff7043]">Next</span>
            </Link>
          </div>
          
          {/* Desktop Navigation - Center */}
          <div className="hidden md:flex space-x-8">
            <Link href="/" className="text-gray-700 hover:text-gray-900 px-1 py-1 text-sm font-medium">
              Home
            </Link>
            <Link href="/products/category/electronics" className="text-gray-700 hover:text-gray-900 px-1 py-1 text-sm font-medium">
              Electronics
            </Link>
            <Link href="/products/category/clothing" className="text-gray-700 hover:text-gray-900 px-1 py-1 text-sm font-medium">
              Clothing
            </Link>
            <Link href="/products/category/home" className="text-gray-700 hover:text-gray-900 px-1 py-1 text-sm font-medium">
              Home & Garden
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-6">
            <Link href="/cart" className="text-gray-700 hover:text-gray-900 relative">
              ...
              {getTotalItems() > 0 && (
                <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform bg-[#ff7043] rounded-full">
                  {getTotalItems()}
                </span>
              )}
            </Link>
            ...
            {user ? (
              <div className="relative">
                ...
                >
                  ...
                  <div className="h-7 w-7 rounded-full bg-gray-100 flex items-center justify-center text-gray-800">
              ...
              <div className="flex items-center space-x-4">
                <Link href="/login" className="text-gray-700 hover:text-gray-900 text-sm">
                  Sign in
                </Link>
                <Link href="/signup" className="bg-[#ff7043] hover:bg-[#e5593b] text-white px-3 py-1.5 rounded text-sm">
                  Sign Up
                </Link>
              </div>
            )}
