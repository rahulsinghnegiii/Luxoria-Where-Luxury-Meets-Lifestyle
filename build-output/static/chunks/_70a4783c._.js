...
"[project]/lib/cloudinaryUtils.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
const CLOUDINARY_UPLOAD_PRESET = ("TURBOPACK compile-time value", "next_ecommerce") || 'next_ecommerce';
const CLOUDINARY_CLOUD_NAME = ("TURBOPACK compile-time value", "del7xvxl7") || 'your-cloud-name';
...
function generateFallbackImage(text = 'Image') {
...
function optimizeCloudinaryImage(url, width = 800, height = 600) {
    ...
    const optimizedUrl = url.slice(0, uploadIndex + 8) + `c_fill,f_auto,q_auto,w_${width},h_${height}/` + url.slice(uploadIndex + 8);
    return optimizedUrl;
}
function isCloudinaryUrl(url) {
    return url && typeof url === 'string' && url.includes('cloudinary.com');
}
function getSafeImageUrl(url, width = 800, height = 600) {
...
const createOrder = async (order)=>{
    ...
    if (USE_MOCK_SERVICES || !isBrowser || !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]) {
        ...
        try {
            ...
            const ordersCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'orders');
            const docRef = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])(ordersCollection, {
                ...order,
                createdAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])()
            });
            return docRef.id;
...
const getAllOrders = async ()=>{
    ...
    if (USE_MOCK_SERVICES || !isBrowser || !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]) {
        ...
        try {
            ...
            const ordersSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(ordersQuery);
            const ordersList = ordersSnapshot.docs.map((doc)=>{
                const data = doc.data();
                return {
                    id: doc.id,
...
const getOrderById = async (orderId)=>{
    ...
    if (USE_MOCK_SERVICES || !isBrowser || !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]) {
        ...
        try {
            ...
            const orderRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'orders', orderId);
            const orderSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(orderRef);
...
const uploadProductImage = async (file)=>{
    ...
    try {
        ...
        const cloudinaryUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudinaryUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImage"])(file);
...
//# sourceMappingURL=_70a4783c._.js.map