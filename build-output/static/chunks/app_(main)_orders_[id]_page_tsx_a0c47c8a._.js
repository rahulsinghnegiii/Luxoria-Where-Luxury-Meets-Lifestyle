...
"[project]/app/(main)/orders/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function OrderDetailPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderDetailPage.useEffect": ()=>{
            const fetchOrder = {
                "OrderDetailPage.useEffect.fetchOrder": async ()=>{
                    if (user && orderId) {
                        try {
                            setIsLoading(true);
                            setError(null);
            ...
            }["OrderDetailPage.useEffect.fetchOrder"];
            if (user) {
                fetchOrder();
            }
        }
...
_s(OrderDetailPage, "ePTsF+U+Io1prMC3PF8ZNRDO98A=", false, function() {
    return [
...
//# sourceMappingURL=app_%28main%29_orders_%5Bid%5D_page_tsx_a0c47c8a._.js.map