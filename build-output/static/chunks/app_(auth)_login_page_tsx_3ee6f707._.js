...
function LoginPage() {
    ...
    let authContext;
    try {
        authContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            if (authError) {
                setError(authError);
                setIsLoading(false);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(authError);
            }
        }
    }["LoginPage.useEffect"], [
        authError
    ...
    const handleSubmit = async (e)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].loading('Attempting to sign in...', {
            id: 'login-attempt'
        });
        try {
...
_s(LoginPage, "2nvVSV3jhLtNPaZ7auei2okyhHs=", false, function() {
    return [
