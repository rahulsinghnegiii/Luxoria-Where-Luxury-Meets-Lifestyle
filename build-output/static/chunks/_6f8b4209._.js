...
const getSafeImageUrl = (originalUrl)=>{
    ...
    if (isFirebaseStorageUrl(originalUrl)) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebaseUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformFirebaseStorageUrl"])(originalUrl);
    }
...
function ImprovedImage({ src, alt, width = 300, height = 300, priority = false, loading, ...props }) {
    ...
    const [safeSrc, setSafeSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(typeof src === 'string' ? src : '');
...
_s(ImprovedImage, "v1lRVf1uiQ77TelI59qGPZ6UMzA=");
_c = ImprovedImage;
var _c;
...
//# sourceMappingURL=_6f8b4209._.js.map